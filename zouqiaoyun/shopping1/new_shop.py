...
#新增会员
    ...
    membersHelper1.add_newmember()

#获取会员列表信息
    membersHelper1.get_allmembers()

#根据手机号后四位获取会员信息
    membersHelper1.get_member_list_by_lastfournumber()

#根据手机号注销会员
    membersHelper1.zhuxiao_member()

#修改会员信息（手机号和折扣）
    update_member=membersHelper1.update_member()
...
#会员可积累购物积分（1元=1积分，1000积分可以打98折，3000积分打95折，5000积分打九折）
    ...
    membersHelper1.get_discount_by_jifen(jifen)
